...
export const PANEL_BODY_TEXT = 'text-xs sm:text-sm'
export const PANEL_META_LABEL =
  'text-[10px] sm:text-xs font-medium uppercase tracking-wider text-white/40'
export const PANEL_SECTION_LABEL = `${PANEL_BODY_TEXT} text-white/60`
export const PANEL_CHIP_TEXT = 'text-xs sm:text-sm'
